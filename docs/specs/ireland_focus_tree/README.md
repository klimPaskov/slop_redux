...
1. `specs/ireland_focus_tree_spec_part_1_core.md`
2. `specs/ireland_focus_tree_spec_part_2_route_architecture.md`
3. `specs/ireland_focus_tree_spec_part_3_historical_route_notes.md`
4. `specs/ireland_focus_tree_spec_part_4_detailed_focus_branches.md`
5. `specs/ireland_focus_tree_spec_part_5_decisions_missions.md`
6. `specs/ireland_focus_tree_spec_part_6_reunification_formables.md`
7. `specs/ireland_focus_tree_spec_part_7_mechanics_presentation.md`
8. `specs/ireland_focus_tree_spec_part_8_ai_matrix.md`
