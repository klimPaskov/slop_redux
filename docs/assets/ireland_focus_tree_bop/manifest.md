...
None for the generated asset package. The five flavour ids are proposed because the prompt described hooks without exact registry ids; implementation should either adopt these ids or rename the DDS triplets before wiring achievements.
