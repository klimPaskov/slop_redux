...
| reload focus | Reloads the focus trees in /Hearts of Iron IV/common/national\_focuses/. |
...
| update\_loc | Reloads the specified localization key. |
...
| research\_on\_icon\_click | Activates research on click, allowing you to click on technologies to research them instantly. |
| Focus.NoChecks | Removes the trigger checks for focuses. |
| Focus.AutoComplete | Activates instant completion for focuses. |
| set\_country\_flag | Sets the specified country flag for the current country. |
| add\_ideas | Adds the specified idea to the current country. |
...
| ai\_trace.log | Prints the AI movements undertaken (divisions, ships, air, etc.) | Low |
...
| system\_debug.log | Prints interface errors. | Medium |
...
## <a id="crash-data-log"></a>Crash data log
...
## <a id="common-crash-causes"></a>Common crash causes
...
### <a id="main-menu-loading"></a>Main menu loading
...
- numbers.pr or career\_profile\_\*.pr - Caused primarily by the strategic regions being broken (usually by a lot of provinces not having one). Since in this state it's impossible to get to the nudger to fix them from there, it is possible to edit their files in a text editor, preferably with help of a tool that helps visualize the map (like the HOI4 Mod Utilities extension for Visual Studio Code).

### <a id="during-country-selection"></a>During country selection
...
### <a id="middle-of-the-game"></a>Middle of the game
...
## <a id="additional-details"></a>Additional details
